        ...
        {otpSent ? (
          <div className="p-6 space-y-5">
            <div className="block gap-4 flex-col items-center justify-center">
              <Image
                src={`/assets/perfumeImage/fawaahlogoblack.webp`}
            ...
            >
              <div className="flex gap-1.5">
                {otp.map((digit, index) => (
                  <input
                    ...
                    onPaste={handlePaste}
                    className="w-8 h-8 rounded-sm border  text-center text-sm focus:outline-none"
                  />
                ))}
              </div>
              ...
              <div>
                <button
                  ...
                  className={`text-black text-xs underline font-medium uppercase ${
          ...
          <div className="p-6 space-y-4">
            <div className="block gap-4 h-20 flex-col items-center justify-center">
              {globalSetting && (
                <Image
                  src={`/assets/perfumeImage/fawaahlogoblack.webp`}
            ...
            >
              <div>
                <input
                  ...
                  className="border rounded-sm text-sm placeholder:text-sm focus:outline-none w-full px-3 py-2 disabled:bg-gray-100"
                />
              </div>
              ...
              <div className="flex items-center gap-1.5">
                ...
                <label
                  htmlFor="agreement"
                  className="text-xs text-black tracking-[0.025em]"
                >
                  I agree to the{" "}
                  <a
                    target="_blank"
              ...
              <div>
                <button
                  type="submit"
                  className="text-sm flex items-center justify-center gap-2 rounded-sm bg-templateBackground w-full p-3 text-templateText tracking-wide"
                >
                  CONTINUE
                </button>
              </div>
