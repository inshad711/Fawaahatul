...
export const metadata: Metadata = {
  title: `Terms of Service | ${defaultMetadata.title}`,
  alternates: {
    canonical: `${process.env.NEXT_PUBLIC_BASE_URL}/pages/terms-of-service`,
  },
};

const Termsandconditions = async () => {
  const policy = await policyService.getPolicy("terms_conditions");
  if (!policy.success) {
    return (
  ...
  return (
    <PolicyContainer
      ...
      policy={policy.data.terms_conditions}
    />
  );
};
